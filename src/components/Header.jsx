...
const Header = () => {
  ...
  const openCodeSmachers = () => {
    window.open('https://codesmachers.netlify.app', '_blank');
  };
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="flex w-[12rem] xl:mr-8 items-center" href="#hero">
          <img src={brainwaveSymbol} width={40} height={40} alt="Dev-Soft" />
          <span className="text-xl font-bold p-2">Dev-Soft</span>
        </a>
        ...
        <Button className="hidden lg:flex" onClick={openCodeSmachers}>
          @CodeSmachers
        </Button>
